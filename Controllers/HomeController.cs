...
public class HomeController : Controller
{
    ...
    public IActionResult Resena(int IdRestaurante)
    {
        ...
        var userJson = HttpContext.Session.GetString("user");
        ViewBag.UsuarioLogueado = !string.IsNullOrEmpty(userJson);
    ...
    [HttpPost]
    public IActionResult CrearResena(int idRestaurante, short valoracion, string opinion)
    {
        var userJson = HttpContext.Session.GetString("user");
        ...
        BD.InsertarResena(idRestaurante, usuario.IdUsuario, valoracion, opinion);
