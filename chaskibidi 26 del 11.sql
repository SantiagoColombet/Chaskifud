USE [master]
GO
/****** Object:  Database [ChaskiBase]    Script Date: 26/11/2024 23:35:35 ******/
CREATE DATABASE [ChaskiBase]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ChaskiBase', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\ChaskiBase.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'ChaskiBase_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\ChaskiBase_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
 WITH CATALOG_COLLATION = DATABASE_DEFAULT, LEDGER = OFF
GO
ALTER DATABASE [ChaskiBase] SET COMPATIBILITY_LEVEL = 160
GO
...
GO
ALTER DATABASE [ChaskiBase] SET AUTO_CLOSE ON 
GO
...
GO
ALTER DATABASE [ChaskiBase] SET RECOVERY SIMPLE 
GO
...
GO
ALTER DATABASE [ChaskiBase] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
ALTER DATABASE [ChaskiBase] SET QUERY_STORE = ON
GO
ALTER DATABASE [ChaskiBase] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
USE [ChaskiBase]
GO
/****** Object:  Table [dbo].[CategoriasComidas]    Script Date: 26/11/2024 23:35:35 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[CategoriasRestaurantes]    Script Date: 26/11/2024 23:35:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Comida]    Script Date: 26/11/2024 23:35:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Mensajes]    Script Date: 26/11/2024 23:35:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Resenas]    Script Date: 26/11/2024 23:35:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Restaurantes]    Script Date: 26/11/2024 23:35:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RestaurantesYComidas]    Script Date: 26/11/2024 23:35:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RestriccionAlimenticia]    Script Date: 26/11/2024 23:35:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Usuario]    Script Date: 26/11/2024 23:35:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[Resenas] ([IdRestaurante], [IdUsuario], [Valoracion], [Opinion], [IdResena], [FechaEscrita], [CantidadAportes], [CantidadVotosArriba], [CantidadVotosAbajo]) VALUES (1, 1, 3, N'"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 3, CAST(N'2018-05-10' AS Date), 4, 5, 3)
INSERT [dbo].[Resenas] ([IdRestaurante], [IdUsuario], [Valoracion], [Opinion], [IdResena], [FechaEscrita], [CantidadAportes], [CantidadVotosArriba], [CantidadVotosAbajo]) VALUES (1, 1, 5, N'hola', 4, CAST(N'2015-02-03' AS Date), 10, 50, 30)
